...
public class TemplateMsgControllerClient {
   ...
   * @throws IOException
   */
  public void sendPreOrderMsg(String token, ShopOrder order, Good updatedGood, boolean async) throws IOException {
    ...
    sendPreOrderMsg(token, user.getOpenid(), message, async);
  }
   ...
   * @throws IOException
   */
  public void sendPickupMsg(String token, ShopOrder order, boolean async) throws IOException {
    if (null == order) {
      return;
    }
    String userid = order.getUserid();
    ...
    sendPickupMsg(token, user.getOpenid(), message, async);
   ...
   * @throws IOException
   */
  public void sendThirdSendMsg(String token, ShopOrder order, boolean async) throws IOException {
    if (null == order) {
      return;
    }
    String userid = order.getUserid();
    ...
    sendThirdSendMsg(token, user.getOpenid(), message, async);
  }
   ...
   * @throws IOException
   */
  public void sendOwnSendMsg(String token, ShopOrder order, boolean async) throws IOException {
    if (null == order) {
      return;
    }
    String userid = order.getUserid();
    ...
    TemplateMsg message = createTemplateMsg(order, keyword1Value, keyword2Value, keyword3Value, keyword4Value,
        keyword5Value, keyword6Value, keyword7Value);
    sendOwnSendMsg(token, user.getOpenid(), message, async);
  }
