...
public interface ShopCartControllerApi {
  ...
  public Observable<ResponseBean<ShopCartItem>> addShopCartItem(@Header(AuthConstants.HEADER_STRING) String token,
  ...
  public Observable<ResponseBean<GetShopCartItemListResponse>> getShopCartItemList(
  ...
  public Observable<ResponseBean<Void>> checkAllShopCartItem(@Header(AuthConstants.HEADER_STRING) String token,
  ...
  public Observable<ResponseBean<Void>> checkShopCartItem(@Header(AuthConstants.HEADER_STRING) String token,
  ...
  public Observable<ResponseBean<Void>> deleteShopCartItem(@Header(AuthConstants.HEADER_STRING) String token,
  ...
  public Observable<ResponseBean<ShopCartItem>> updateShopCartItemCount(
      @Header(AuthConstants.HEADER_STRING) String token, @Path("userid") String userid,
      @Path("shopcartid") String shopcartid, @Path("count") int count);
  ...
  public Observable<ResponseBean<Void>> deleteGood(@Header(AuthConstants.HEADER_STRING) String token,
