...
public interface GoodControllerApi {
  ...
  public Observable<ResponseBean<GetClassifyGoodListResponse>> getClassifyGoodList(
      @Header(AuthConstants.HEADER_STRING) String token, @Path("classifyid") String classifyid,
   ...
   */
  @POST(value = "/good")
  public Observable<ResponseBean<Good>> createGood(@Header(AuthConstants.HEADER_STRING) String token,
  ...
  public Observable<ResponseBean<Good>> getGood(@Header(AuthConstants.HEADER_STRING) String token,
  ...
  public Observable<ResponseBean<Void>> deprecateGood(@Header(AuthConstants.HEADER_STRING) String token,
      @Path("goodid") String goodid);
  ...
  public Observable<ResponseBean<GoodDetail>> getGoodDetail(@Header(AuthConstants.HEADER_STRING) String token,
      @Path("goodid") String goodid);
  ...
  public Observable<ResponseBean<Good>> updateGood(@Header(AuthConstants.HEADER_STRING) String token,
