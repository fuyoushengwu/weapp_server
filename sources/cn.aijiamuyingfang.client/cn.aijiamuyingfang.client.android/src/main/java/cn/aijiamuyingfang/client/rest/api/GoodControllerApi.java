...
public interface GoodControllerApi {
  ...
  public Observable<ResponseBean<Good>> getGood(@Path("goodid") String goodid);
  ...
  public Observable<ResponseBean<Void>> deprecateGood(@Path("goodid") String goodid,
      @Query("access_token") String accessToken);
  ...
  public Observable<ResponseBean<GoodDetail>> getGoodDetail(@Path("goodid") String goodid);
  ...
  public Observable<ResponseBean<Good>> updateGood(@Path(value = "goodid") String goodid, @Body Good request,
      @Query("access_token") String accessToken);
}
