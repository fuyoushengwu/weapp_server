...
public final class AuthState {
  ...
  private static final int[] ACCESS_STATES = new int[] { NO_AUTH, BASIC_AUTH, AUTHORIZATION_AUTH, FINAL_AUTH };

  private static final int[] REFRESH_STATES = new int[] { NO_AUTH, AUTHORIZATION_AUTH, FINAL_AUTH };
